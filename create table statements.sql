drop database if exists newimpact;

create database newimpact;
use newimpact;
...
CREATE TABLE Source (
  ...
  share_parent tinyint DEFAULT NULL,
  share_child tinyint DEFAULT NULL,
  scrape tinyint DEFAULT NULL,
...
CREATE TABLE Discourse (
  discourse_id int NOT NULL AUTO_INCREMENT,
  content text,
...
CREATE TABLE ImpactArea (
  ...
  source_parent_id int DEFAULT NULL,
  impact_parent_id int DEFAULT NULL,
...
CREATE TABLE DiscourseImpactArea (
  discourse_id int DEFAULT NULL,
  impact_area_id int DEFAULT NULL,
  model_id int DEFAULT NULL,
